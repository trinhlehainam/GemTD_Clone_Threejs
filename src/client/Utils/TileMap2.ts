...
export default class TileMap2 {
    ...
    getWorldPosFromVector3(pos: Vector3, tilePortion: number = 0.5): Vector3 {
        let ret = pos.clone();
        const tmpY = ret.y;
        return ret
    ...
    getWorldPosFromTilePos(tilePos: Vector2): Vector3;
    getWorldPosFromTilePos(x: number, y: number): Vector3;

    getWorldPosFromTilePos(a: Vector2 | number, b?: number): Vector3{
